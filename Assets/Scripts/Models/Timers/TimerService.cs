...
namespace Models.Timers
{
 public interface ITimerService
    ...
    public class TimerService : ITimerService
    {
        ...
        public void AddGameTimer(int currentSec, Action<int> timeModelTick, Action timeModelEndEvent, bool ignoreTimeScale = true)
        {
            if (_tmpTimeModels.Count >= 1)
            {
                _tmpTimeModels[0].Init(currentSec, TimerTypeEnum.Game, timeModelTick, timeModelEndEvent, ignoreTimeScale);
